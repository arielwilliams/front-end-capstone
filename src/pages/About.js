...
//             <div
//               key={element.id}
//               className="border p-4 rounded shadow bg-white bg-opacity-100 flex"
//             >
//               {element.image && (
//                 <img
//                   src={element.image}
//                   alt={element.name}
//                   className="rounded-full w-16 h-16 md:w-24 md:h-24 mr-4"
//                 />
//               )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {aboutUsData.map((element) => (
            <div
              ...
              className="border p-4 rounded shadow bg-white bg-opacity-100 flex"
            >
              <div className="w-24 h-24 md:w-24 md:h-24 mr-4 flex-shrink-0">
                {element.image && (
                  <img
                    src={element.image}
                    alt={element.name}
